...
//insertion dans la table des recette
	if($montant != 0)
		$connexion->registerCantineRecette($montant,$elv['nom_e'],$elv['prenom_e']); 
//insertion dans la table cantine
$connexion->registerCantine($_GET['elv']);
//selection du mois payé
$mois = $connexion->selectMoisCantine($_GET['elv']);		
...
<barcode type="EAN13" value="123467891245" style="margin-left:100mm;margin-top:10mm;width: 30mm; height: 12mm; font-size: 4mm"></barcode>
   ...
   <i>
        <h3><u>RECU</u>: &laquo;<?php echo 'N° C'.$mois['mois_c'].'-'.$elv['id_e'];?> &raquo;</b><br></h2>
        ...
        <p style="font-size:17px;">Motif: Payement de la cantine du <?php echo '<strong>'.$mois['mois_c'].'<sup>e</sup> mois</strong>';?> </p>
        <br>
    </i>
