    ...
    RGraph.AllowResizing = function (obj)
    {
        ...
        */
        if (obj.get('chart.resizable') && !ca.rgraphResizewrapper) {
            ...
            //
            // If the canvas is wrapped in a DIV that was added by RGraph, use that. Otherwise wrap the canvas.
            //
            if (ca.parentNode && ca.parentNode.tagName === 'DIV' && ca.parentNode.id && ca.parentNode.id.substring(0, 27) === 'rgraphAttributionContainer_') {
                ca.rgraphResizewrapper = ca.parentNode;

            } else if (!ca.rgraphResizewrapper) {
